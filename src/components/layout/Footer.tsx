...
const faculties = [
  ...
  { name: 'Janapriya Institute of Paramedical Sciences, Hassan', href: '/academics?tab=faculties#paramedical' },
  ...
  { name: 'Janapriya College of Physiotherapy (Hassan & Mangalore)', href: '/academics?tab=faculties#physiotherapy' },
];
          ...
          <div>
            ...
            <div className="space-y-3 text-sm mb-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:jipmshassan@gmail.com" className="text-primary-foreground/80 hover:text-accent transition-colors">
                  jipmshassan@gmail.com
                </a>
              </div>
            </div>
