...
export function HeroSlider() {
  ...
  return (
    <section className="relative h-[500px] md:h-[600px] lg:h-[700px] overflow-hidden">
            ...
            <div className="section-container">
              <div className={`max-w-2xl transition-all duration-700 ${
                ...
                <Link to={slide.ctaLink}>
                  <Button 
                    size="lg" 
                    className="bg-accent text-accent-foreground hover:bg-accent-dark font-semibold px-8"
                  >
                    {slide.cta}
                  </Button>
                </Link>
      ...
      <button
        onClick={prev}
        className="absolute left-4 top-1/2 -translate-y-1/2 p-2 rounded-full bg-primary-foreground/20 text-primary-foreground hover:bg-primary-foreground/30 transition-colors hidden md:block"
      ...
      <button
        onClick={next}
        className="absolute right-4 top-1/2 -translate-y-1/2 p-2 rounded-full bg-primary-foreground/20 text-primary-foreground hover:bg-primary-foreground/30 transition-colors hidden md:block"
