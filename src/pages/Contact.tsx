          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div><Label>Phone</Label><Input type="tel" className="mt-1" /></div>
                <div><Label>Subject *</Label><Input required className="mt-1" /></div>
                <div><Label>Message *</Label><Textarea required className="mt-1" rows={4} /></div>
                <Button type="submit" className="bg-primary hover:bg-primary-dark text-primary-foreground">Send Message</Button>
              </form>
            </div>
              ...
              <div className="bg-secondary rounded-xl p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div><h4 className="font-medium text-foreground">Email</h4><a href="mailto:jipmshassan@gmail.com" className="text-muted-foreground text-sm hover:text-primary">jipmshassan@gmail.com</a></div>
                  </div>
                </div>
              </div>
