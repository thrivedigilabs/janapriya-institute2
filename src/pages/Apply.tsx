        ...
        <div className="section-container">
          <div className="max-w-3xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-secondary rounded-xl p-6 md:p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input id="percentage" placeholder="e.g., 75% or 7.5 CGPA" required className="mt-1" />
                  </div>
                </div>
              ...
              {/* Submit */}
              <div className="pt-4">
                <Button type="submit" size="lg" className="w-full bg-primary hover:bg-primary-dark text-primary-foreground">
                  Submit Application
                </Button>
