...
const faculties = [
  ...
  },
  {
    ...
    description: 'The College of Physiotherapy offers comprehensive training in physical rehabilitation and therapy. With modern rehabilitation equipment and extensive clinical exposure at partner hospitals, students develop expertise in musculoskeletal, neurological, and cardiopulmonary rehabilitation.',
    image: facultyPhysio,
    programs: ['BPT - Bachelor of Physiotherapy (4 Years + 6 Months Internship)'],
    eligibility: '10+2 Science, Age 17+',
    affiliation: 'RGUHS',
    contact: 'Hassan: +91 99007 47923 | Mangalore: +91 91482 47799',
    location: 'Hassan & Mangalore Campuses',
    hasDetails: false,
  },
];
...
const programs = {
  undergraduate: [
    ...
    { name: 'Bachelor of Physiotherapy (BPT)', duration: '4 Years + 6 Months Internship', location: 'Hassan & Mangalore' },
