          ...
          {activeTab === 'leadership' && (
            <div className="max-w-5xl">
              ...
              <div className="bg-secondary rounded-xl overflow-hidden mb-8">
                <div className="grid md:grid-cols-3 gap-0">
                  <div className="md:col-span-1">
                    <img src={chairman} alt="Dr Abdul Basheer VK" className="w-full h-full min-h-[300px] object-cover object-top" />
                  </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {/* Managing Director */}
                <div className="bg-secondary rounded-xl p-6">
                  <h3 className="text-lg font-bold text-foreground">Hon. Shri. Vinay Ramakrishna</h3>
                  <p className="text-sm text-muted-foreground mb-1">B.E., MBA (UK)</p>
                  <p className="text-accent-dark text-sm mb-4">Managing Director</p>
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    A foundation built on values, with the objective of creating centers of excellence for education in the field of Nursing. 
                    We have created a learning culture, a friendly environment that facilitates complete development of our students. 
                    Our three pronged focus on knowledge, skill and attitude is aimed at meeting the needs of our students. 
                    We are confident that your life at our campus will be academically fruitful and pleasant.
                  </p>
                </div>

                {/* Director of Health Sciences */}
                <div className="bg-secondary rounded-xl p-6">
                  <h3 className="text-lg font-bold text-foreground">Director of Health Sciences</h3>
                  <p className="text-accent-dark text-sm mb-4">JP Groups</p>
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    As an educational institute we have always prided ourselves on our cutting edge approach to education. 
                    We believe that education has to keep pace with the world and today when the world can change at a moment's notice, 
                    we have managed to keep our students at par with the best in the world. 
                    This can only happen when everybody is geared towards ensuring best practices, and that is definitely the case at JP Groups.
                  </p>
                  <p className="text-muted-foreground text-sm leading-relaxed mt-3">
                    Our approach to education has always been aimed at involving the students in academics through light topics and discussions. 
                    We have the best technology in place for ensuring that our students do not miss out on anything.
                  </p>
                </div>
              </div>
            </div>
